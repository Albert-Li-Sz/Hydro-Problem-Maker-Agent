...
const allowValue = process.env.HYDRO_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; HYDRO_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  - verify workspace package metadata and generated model data if they changed");
...
console.error("  HYDRO_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
