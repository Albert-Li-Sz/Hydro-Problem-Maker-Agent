...
The package does not decide whether an algorithm is correct. Agent reasoning, sandboxed compilation, differential testing, and live Hydro acceptance are separate gates.
