...
/**
 * Converts models.dev verified effort values into the selectable thinking levels.
 * Values without a shared equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
